...
var hoc = (0, _src.default)('(min-width: 960px)', 'isDesktop', 'Desktop');
var WrappedComp = hoc(Comp);
...
},{"../src":19,"react":12,"react-dom":9}],2:[function(require,module,exports){
'use strict';
...
Object.defineProperty(exports, "default", {
  enumerable: true,
  get: function get() {
    return _withResponsive.default;
  }
});

var _withResponsive = _interopRequireDefault(require("./withResponsive"));
...
},{"./withResponsive":20}],20:[function(require,module,exports){
"use strict";
...
var match = (0, _memoizeOne.default)(window.matchMedia);

var withResponsive = function withResponsive() {
  ...
  return function (Comp) {
    var query = params[0],
        identifier = params[1],
        _params$ = params[2],
        displayName = _params$ === void 0 ? 'Responsive' : _params$;
    ...
    function (_PureComponent) {
      ...
      function Responsive() {
        ...
        _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Responsive)).call.apply(_getPrototypeOf2, [this].concat(params)));
      ...
      _createClass(Responsive, [{
        ...
        value: function render() {
          ...
          return _react.default.createElement(Comp, _extends({}, props, _defineProperty({}, identifier, isMatch)));
        }
      }]);
...
var _default = withResponsive;
exports.default = _default;

},{"memoize-one":2,"react":12}]},{},[1]);
